...
//Giris::Personel::ContainerWidgetDeprecated::ContainerWidgetDeprecated(mongocxx::database *_db, bsoncxx::document::value _user, std::string ContainerTitle)
...
//    :ContainerWidgetDeprecated::ContainerWidgetDeprecated(_database,_user),mesajOid(mesajoid)
//{
...
//    :ContainerWidgetDeprecated::ContainerWidgetDeprecated( _database , _user,"Arıza Kayıtları")
//{
